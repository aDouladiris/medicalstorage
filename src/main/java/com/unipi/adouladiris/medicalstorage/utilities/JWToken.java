...
public class JWToken {
    ...
    public JWToken(Authentication authenticatedUser, String expMinutes) throws NoSuchAlgorithmException, InvalidKeyException {
        ...
        this.payload.put("jti", UUID.randomUUID().toString()); //how do we use this?
        this.signature = hmacSha256(this.encodedHeader + "." + encode(payload), SECRET_KEY);
    }
    ...
    private String hmacSha256(String data, String secret) throws InvalidKeyException, NoSuchAlgorithmException {
        try {
